            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('admin.toy.save') }}" enctype="multipart/form-data">
                        @csrf
                        <input type="text" class="form-control mb-2" placeholder=@lang('admin.toys.name') name="model" value="{{ old('model') }}" />
                        ...
                        <select class="form-control mb-2" id="storage" name="storage">
