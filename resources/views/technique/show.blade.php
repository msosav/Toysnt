...
<div class="row g-5">
    ...
    <div class="col-md-3">
        <div class="px-2 py-2 d-block">
            ...
            <a href="{{ route('cart.add', ['id'=> $viewData['technique']->getId()]) }}" class="btn btn-outline">@lang('app.technique.cart')</a>
        </div>
...
<div class="row d-flex justify-content-center py-5 px-2">
    <div class="card-body p-4">
        ...
        <form action="{{ route('review.save', ['type' => 'technique', 'id' => $viewData['technique']->getId()]) }}" method="POST">
            @csrf
            <div class="card m-2">
